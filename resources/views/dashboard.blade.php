...
<link rel="stylesheet" type="text/css" href="../assets-minified/elements/buttons.css">

<div class="btn-group btn-group-justified">

                        <a class="btn btn-{{($days==1)?'default':'primary'}}" role="button" href="javascript:ajaxLoad('{{url('dashboard1?days=1')}}')">Yesterday</a>
                        <a class="btn btn-{{($days==7)?'default':'primary'}}" role="button" href="javascript:ajaxLoad('{{url('dashboard1?days=7')}}')">Last 7 Days</a>
                        <a class="btn btn-{{($days==30)?'default':'primary'}}" role="button" href="javascript:ajaxLoad('{{url('dashboard1?days=30')}}')">Last 30 Days</a>
                        <a class="btn btn-{{($days==60)?'default':'primary'}}" role="button" href="javascript:ajaxLoad('{{url('dashboard1?days=60')}}')">Last 60 Days</a>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="tile-box tile-box-alt bg-blue">
                                <div class="tile-header">Total FTD</div>
                                <div class="tile-content-wrapper"><i class="glyph-icon icon-inbox"></i>
                                    <div class="tile-content"><i class="glyph-icon icon-caret-up font-red"></i> {{ $total_ftd }}</div><small><i class="glyph-icon icon-caret-up"></i> </small></div><a href="#" title="" class="tile-footer">view details <i class="glyph-icon icon-arrow-right"></i></a></div>
                        </div>
                        <div class="col-md-3">

                            <div class="tile-box tile-box-alt bg-default">
                        ...
                        <div class="col-md-3">
                            <div class="tile-box tile-box-alt bg-green">
                                <div class="tile-header">Today's FTD</div>
                                <div class="tile-content-wrapper"><i class="glyph-icon icon-cloud-download"></i>
                                    <div class="tile-content"><i class="glyph-icon icon-arrow-up font-green"></i> {{$today_ftd_no}}<span></span></div><small>12% have started the download</small></div><a href="#" title="" class="tile-footer">view details <i class="glyph-icon icon-arrow-right"></i></a></div>
                        </div>
                        <div class="col-md-3">
                            <div class="tile-box tile-box-alt bg-red" title="">
                                <div class="tile-header">Today's FTD Balance</div>
                                <div class="tile-content-wrapper"><i class="glyph-icon icon-credit-card"></i>
                                    <div class="tile-content">${{$today_ftd_balance}}<span></span></div><small><i class="glyph-icon icon-caret-up"></i> $272 daily revenue from all sales</small></div><a href="#" title="" class="tile-footer">view details <i class="glyph-icon icon-arrow-right"></i></a></div>
                        </div>
                    </div>
                    <div class="row">
                        {{-- <div class="col-md-8">
